...
<body>
    ...
    echo "As constantes em PHP podem começar com uma letra ou underline, mas não tem o sinal $ antes de seu nome<br>Para criar uma constante utilizamos a função <strong>define()</strong><br>";
